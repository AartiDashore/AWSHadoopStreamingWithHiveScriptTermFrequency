====================================
README: Term Frequency Hadoop Project
====================================

Project Description:
---------------------
This project runs a Hadoop Streaming pipeline that calculates term frequency statistics across a set of textcorpora.
It involves two MapReduce jobs (2 Mappers and 2 Reducers python files), three shell scripts and a Hive query for further processing.
